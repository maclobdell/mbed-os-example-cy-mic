...
#define CYBSP_PDM_PCM_ENABLED 1U
#define CYBSP_PDM_PCM_HW PDM0
#define CYBSP_PDM_PCM_IRQ audioss_0_interrupt_pdm_IRQn
...
extern const cy_stc_pdm_pcm_config_t CYBSP_PDM_PCM_config;
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t CYBSP_PDM_PCM_obj;
#endif //defined (CY_USING_HAL)
